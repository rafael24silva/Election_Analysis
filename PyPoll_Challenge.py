...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_vote_total_percentage = float(county_vote_total) / float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        county_results = (f"{county_name}: {county_vote_total_percentage:.1f}% ({county_vote_total:,})\n")
